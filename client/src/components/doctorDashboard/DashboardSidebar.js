    ...
    <div className="h-screen overflow-y-hidden w-screen grid grid-cols-12">
      <div className="side_bar bg-white shadow col-span-2">
        <div className="flex m-2 mt-4  ">
          ...
          <div className="heading font-poppins font-bold text-xl py-6 text-blue-800 ">
            <Link to="/">
              <h1>MediPlus</h1>
            </Link>
          </div>
        ...
        <div className=" mx-auto mt-56 py-1    bg-blue-400  rounded font-semibold font-poppins shadow-sm hover:bg-blue-200 w-2/5  ">
