        ...
        <div className="">
          ...
          >
              ...
              <button
                ...
                className={
                  Toggle === "Patient"
                    ...
                    : "py-2 px-8 text-lg font-poppins font-semibold cursor-pointer rounded bg-blue-100"
                }
              >
                Patient
              </button>
            ...
            >
              ...
              <div className="border-4 p-4 mx-auto w-1/2 rounded-xl mt-8 border-blue-600  ">
                <h1>Email us at </h1>
                <div>
                  <div className=" rounded-xl p-4 mt-4 ">
                    <h1 className="font-bold">Email :</h1>
                    <p>b23finalyear@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-4 mr-4">
                <label className="font-bold lg:text-xl px-4 ">D.O.B</label>
                <input
                  type="date"
              ...
              <div className="lg:grid lg:grid-cols-10 gap-2 mt-8 mr-40">
                <div className="col-span-5">
                  <label className=" lg:text-xl font-bold px-4 grid col-start-1 col-span-3">
                    Onging Medications (if any)
                  </label>
                </div>
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              ...
              <div className="flex justify-center mb-4 mt-8">
                {Loading ? (
                  ...
                  <button className="bg-blue-400 rounded p-2 px-8 font-bold text-xl hover:bg-blue-200 mb-4 ">
                    Submit
                  </button>
                )}
              </div>
