    ...
    <div className="body w-full ">
      ...
      <div className="bg-secoundry ">
        ...
        <div className="lg:grid lg:grid-cols-2 mt-4 ">
          <div>
            <div className="max-w-full  lg:mx-32 mx-4 my-8 bg-white py-8 px-16 rounded-3xl  border-8 border-blue-500">
              ...
              <div className="">
                ...
                <h1 className="font-poppins text-xl">b23finalyear@gmail.com</h1>
              </div>
              <div>
                <h1 className="font-bold font-poppins text-2xl mt-4 ">
                  Address :
                ...
                B-23, CSE - B, Heritage Institute of Technology, Kolkata-700107{" "}
                </h2>
              </div>
            </div>
          </div>
              ...
              <form className="grid  gap-8 " ref={form} onSubmit={sendEmail}>
                ...
                <div className="grid grid-cols-4">
                  ...
                  <textarea
                    ...
                    rows="4"
                    cols="25"
                    placeholder="type your suggestion/query here"
                    name="message"
                ...
                <div className="flex justify-center ">
                  {Loading ? (
                    ...
                    <button className="text-lg mt-2 bg-blue-400 py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-blue-100">
                      Submit
                    </button>
                  )}
                </div>
