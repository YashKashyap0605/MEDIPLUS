...
import profile from "../../assets/img/landingPage/profile2.png";
...
export default function Login(props) {
  ...
  return (
    <div className="bg-blue-50 flex flex-col justify-items-center items-center py-4 px-4 rounded shadow-md lg:w-3/4 w-full my-7 ml-auto ">
      <h1 className="text-3xl font-bold font-poppins text-blue-600 py-5">
        Login
      </h1>
      <div className="flex bg-blue-100 w-fit justify-between rounded">
        <button
          className={
            Toggle === "Patient"
              ? "py-2 px-8 text-lg font-poppins font-semibold cursor-pointer rounded bg-blue-400"
              : "py-2 px-8 text-lg font-poppins font-medium text-blue-800 cursor-pointer rounded"
          }
          onClick={() => {
            setToggle("Patient");
            setUsername("");
      ...
      <form className="flex flex-col w-full px-8" onSubmit={handleLogin}>
        ...
        <input
          ...
          name="username"
          id="username"
          className="font-poppins px-3 py-2 bg-blue-100 rounded outline-none"
          value={username}
        ...
        {Loading ? (
          ...
          <button
            type="submit"
            className="text-lg mt-10  bg-blue-400 py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-blue-200"
          >
            Login
          </button>
        )}
