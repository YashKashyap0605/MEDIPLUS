...
export default function Navbar() {
  ...
  return (
    <nav className="lg:bg-white lg:w-screen lg:h-14 shadow-sm lg:px-16 lg:py-3 flex justify-items-center items-center  w-full ">
      ...
      <ul className="flex ml-auto lg:w-80 justify-evenly  font-lato font-semibold w-64 ">
        <li>
          <Link to="/">Home</Link>
        </li>
        <li>
      ...
      <button className="bg-blue-400 lg:py-2 lg:px-3 rounded font-semibold font-poppins shadow-sm hover:bg-blue-200 py-1 px-2 mr-2">
