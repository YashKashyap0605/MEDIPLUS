        ...
        <div class="">
          ...
          >
            <div class="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
              <h1
                className={
                  "py-2 px-8 text-lg font-poppins font-semibold cursor-text rounded bg-blue-400"
                }
              >
                Doctor
              </h1>
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-bold text-base px-4 ">D.O.B</label>
              <input
                type="date"
            ...
            <div class=" aadhar grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-bold text-base px-4 ">Aadhar Number </label>
