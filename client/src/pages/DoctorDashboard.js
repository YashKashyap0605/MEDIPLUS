        ...
        <div className="main    m-2  ">
          ...
          <div className="">
            <div className="flex  h-12 m-2 bg-bgprimary rounded mt-4 ">
              ...
              <div className="flex w-96 ml-4 text-xl   ">
                {/* <input
                  placeholder="Search"
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4   ml-auto h-14 w-5/5 mr-0 ">
                  <img
                    src={doctor_profile}
          ...
          >
            ...
            {Loading ? (
              ...
              <div className=" grid col-start-8  h-10 ml-4  bg-blue-400  rounded font-semibold font-poppins shadow-sm hover:bg-blue-200  ">
            ...
            <div className="grid col-start-9  h-10 ml-4  bg-blue-400  rounded font-semibold font-poppins shadow-sm hover:bg-blue-200">
              <div className="flex py-2 px-4 items-center ">
                <div
              ...
              <div className="m-4 p-4 ">
                ...
                {prescriptions.length > 0 ? (
                  <div className="bg-white mt-4 font-poppins p-4 rounded-xl shadow px-8">
                    ...
                    >
                      <div className=" mt-2 flex items-center justify-evenly text-base bg-blue-400 py-1 px-2 rounded font-semibold font-poppins shadow-sm hover:bg-blue-200 w-5/12  ">
            ...
            <div className="font-poppins m-4  ">
              <div className="flex justify-between m-8">
                <div className="font-bold text-xl ml-4">
                  <h1>Recent Visit Details : </h1>
                </div>
                <Link to="/doctor/addDiagno">
                  <div className=" flex  bg-blue-400 pl-0 pr-3 py-1 items-center justify-items-center  rounded font-semibold font-poppins shadow-sm hover:bg-blue-200   ">
                    <img
                      src={add_pre_logo}
                      className="h-3 mx-3"
                      alt="adddiagno"
                    ...
                    prescriptions.slice(1, 3).map((prescription) => {
                      return (
                        <div className="grid grid-cols-4">
                          ...
                          >
                            <div className=" flex  justify-center bg-blue-400 py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-blue-200 w-2/5   ">
                              <img
                                src={eye}
